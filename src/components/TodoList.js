...
function TodoList() {
  ...
  if(activeFilter !== "all"){
    filtered = items.filter((todo) => activeFilter === "active" ? todo.completed === false && todo : todo.completed === true); // filtered değişkenine items'ı filtreliyorum. activeFilter === "active" ? todo.completed === false && todo : todo.completed === true => activeFilter "active" ise todo.completed, false ise todo'yu döndürüyorum. activeFilter "completed" ise todo.completed true ise todo'yu döndürüyorum.
  }
